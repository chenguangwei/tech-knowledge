...
![img](https://pic1.zhimg.com/80/v2-497cbfc541d77fe0245c52bf29e5b684_1440w.jpg)



然后将占用最高的pid转换为16进制`printf '%x\n' pid`得到nid

![img](https://pic2.zhimg.com/80/v2-ced2edca507b646bfa4af07f5b221119_1440w.jpg)



接着直接在jstack中找到相应的堆栈信息`jstack pid |grep 'nid' -C5 –color`

![img](https://pic1.zhimg.com/80/v2-e04193ed1430db9fbb72e8399834eb44_1440w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-f24d0d9f817ce13ec766e057c34d2eeb_1440w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-f9a99a357aff4fcb3ca6a56757bf206a_1440w.jpg)

cs(context switch)一列则代表了上下文切换的次数。

如果我们希望对特定的pid进行监控那么可以使用 pidstat -w pid命令，cswch和nvcswch表示自愿及非自愿切换。

![img](https://pic1.zhimg.com/80/v2-2f6b87fedde3c06756bb99d2f6f9c3f0_1440w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-81db0dc9761d9af20e4b4263940ab57f_1440w.jpg)



更多时候，磁盘问题还是性能上的问题。我们可以通过iostatiostat -d -k -x来进行分析

![img](https://pic1.zhimg.com/80/v2-56cebcf59f0b055b9e2cf0f87e4fcdac_1440w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-c1f52a20fe1087779142bdb08c9ec51a_1440w.jpg)



不过这边拿到的是tid，我们要转换成pid，可以通过readlink来找到pidreadlink -f /proc/*/task/tid/../..。

![img](https://pic1.zhimg.com/80/v2-f35350fbfdefdcfd239079a7d94614c8_1440w.jpg)



找到pid之后就可以看这个进程具体的读写情况cat /proc/pid/io

![img](https://pic1.zhimg.com/80/v2-fd6012e352f85816b67f40f4e1695450_1440w.jpg)



我们还可以通过lsof命令来确定具体的文件读写情况lsof -p pid

![img](https://pic1.zhimg.com/80/v2-4b7ed00069f4f92b1b42779c8908a22c_1440w.jpg)
...
![img](https://pic1.zhimg.com/80/v2-7087d4069534b23c216a0b8bc75945cc_1440w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-5be1dce5deb93cdd4776296d51e0a317_1440w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-fd872fd8334e31500b70264d8988b636_1440w.jpg)
...
![img](https://pic1.zhimg.com/80/v2-4852b2bbd570ee8679667d8b42b97444_1440w.jpg)
...
![img](https://pic1.zhimg.com/80/v2-a3208d1d3943f5afaee46cf2272790cc_1440w.jpg)



或者直接通过查看/proc/pid/task的数量即为线程数量。

![img](https://pic2.zhimg.com/80/v2-4f8bd06641ac7b98ce8f438558fce399_1440w.jpg)
...
![img](https://pic1.zhimg.com/80/v2-8846f4642eccd1e4fd62b857f3ef2628_1440w.jpg)



我们如果确定有可疑的内存端，需要通过gdb来分析gdb --batch --pid {pid} -ex "dump memory filename.dump {内存起始地址} {内存起始地址+内存块大小}"

![img](https://pic1.zhimg.com/80/v2-36da0882873aa33406cd9475a0fc1130_1440w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-05c6813ecf0b05529b58bd5534d17a43_1440w.jpg)



然后等放一段时间后再去看看内存增长的情况，通过jcmd pid VM.native_memory detail.diff(summary.diff)做一下summary或者detail级别的diff。

![img](https://pic2.zhimg.com/80/v2-49a02ae096993504ad5e8093fe200155_1440w.jpg)

![img](https://pic3.zhimg.com/80/v2-5c91ffd8dafa1c42870a7d2eefceb272_1440w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-a4ce7b10784ccde83cde9c1164adf4f2_1440w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-8366aa70322be012afece6a1470a0dc3_1440w.jpg)
...
![img](https://pic2.zhimg.com/80/v2-8d7039f03d54d3790d5f6cc255c60c89_1440w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-f5697bf0ea84bbbc0121e623e40f98fa_1440w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-e4d248242b7747c524bce0a7b1489c4e_1440w.jpg)

如上图所示，overflowed表示全连接队列溢出的次数，sockets dropped表示半连接队列溢出的次数。

### **ss命令，执行ss -lnt**

![img](https://pic4.zhimg.com/80/v2-d67811340f19d59d6c4760e74965baf3_1440w.jpg)
...
![img](https://pic1.zhimg.com/80/v2-2314e03777a58493a274533d7e9741b0_1440w.jpg)

接下来我们通过wireshark打开抓到的包，可能就能看到如下图所示，红色的就表示RST包了。

![img](https://pic2.zhimg.com/80/v2-eb8bdaa0127dc8cb48a0f97f0ed542ed_1440w.jpg)
...
![img](https://pic2.zhimg.com/80/v2-7634ccbe9502c93040e7e00c75754aad_1440w.jpg)
